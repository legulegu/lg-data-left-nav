        ...
        <NavPanelGroup show={this.state.selectedIndex > 0}>
          ...
          <NavPanel show={this.state.selectedIndex === 7}>
            <LinkGroup>
              ...
              <Link href="/stockdata/below-net-asset-statistics?marketId=000016.XSHG" highlight>上证50 破净股统计</Link>
              <Link href="/stockdata/below-net-asset-statistics?marketId=000905.XSHG" highlight>中证500 破净股统计</Link>
